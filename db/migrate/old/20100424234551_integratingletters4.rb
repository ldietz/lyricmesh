class Integratingletters4 < ActiveRecord::Migration
  def self.up

    require 'nokogiri'
    require 'open-uri'
    
doc3 = Nokogiri::HTML(open("http://www.azlyrics.com/h.html"))
col1 = doc3.css("#col1")
col1 = col1.to_s
while 1
  startlink = col1 =~ /href/
  if startlink != nil
    ...
    soundtrackyes = nil
    puts "asdf"
      doc = Nokogiri::HTML(open("http://www.azlyrics.com/#{firstletter}/#{link}"))
    puts "printhtml"
   ...
   # artistfind.gsub!(" ", "")
      ...
      artistfind = albumfind
      realartiststart = artistfind =~ /\/lyrics/
      artistfind.slice!(0..realartiststart + 7)
      realartistend = artistfind =~ /\//
      artistfind = artistfind.slice(0..realartistend -1)
      

      
      # artistfind.gsub!(/'/, "")
     # artistfind = link
     # if artistfind == "rice.html"
     #   artistfind = "damienrice.html"
     # end
     # if artistfind == "bedingfield.html"
     #   artistfind = "danielbedingfield.html"
     # end
     # if artistfind == "thomas.html"
     #   artistfind = "dantethomas.html"
     # end
     # if artistfind == "hayes.html"
     #   artistfind = "darrenhayes.html"
     # end
     # if artistfind == "dashboard.html"
     #   artistfind = "dashboardconfessional.html"
    #  end
    #  if artistfind == "matthews.html"
    #    artistfind = "davematthews.html"
    #  end
    #  if artistfind == "banner.html"
    #    artistfind = "davidbanner.html"
    #  end
    #  if artistfind == "bowie.html"
    #    artistfind = "davidbowie.html"
    #  end
    #  if artistfind == "franj.html"
    #    artistfind = "davidfranj.html"
    #  end
    #  if artistfind == "sneddon.html"
    #    artistfind = "davidsneddon.html"
    #  end
    #  if artistfind == "usherd.html"
    #    artistfind = "davidusher.html"
    #  end
    #5.times do artistfind.chop! end
    puts artistfind
  ...
  while album != nil do  
    ...
    if soundtrackyes != nil
      ...
      next_album_position =  albumfind =~ /EP/
    else
   ...
   # end
    ...
    while next_album_position > startalbum
     ...
     # if check_for_sound != nil
      ...
      check_for_ep =  albumfind =~ /EP/
      epyes = nil
      puts check_for_ep
      if check_for_ep != nil
        if startalbum > check_for_ep
          epyes = 1
          puts first_time_ep
          if first_time_ep == nil
            next_album_position = 0
            first_time_ep = 1
          end
        end
